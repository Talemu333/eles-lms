...
if not re.search(pattern, text, flags=re.S):
    raise SystemExit('Malformed password reset block was not found.')

block = '''// PASSWORD_RESET_IMPLEMENTED
...
fixed = re.sub(pattern, block, text, count=1, flags=re.S)
path.write_text(fixed, encoding='utf-8')
print('Password reset block repaired.')
